 ...
 * 我的借条,还款中
 */
public class MyLoanRepayActivity extends BaseActivity {
    /**
     * 列表
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_loan_repay);
        init();
    }
    ...
    public void init() {
        ...
        //设置iaddItemDecoration(decoration);
        adapter.setOnItemClickListener(new OnRecyclerItemCLickListener() {
            @Override
            public void onItemClick(View view, int flag) {
                switch (flag) {
                    case 1:
                        Utils.intnet(MyLoanRepayActivity.this, LoaningActivity.class);
                        break;
                    case 2:
                        Utils.intnet(MyLoanRepayActivity.this, LoanUserInfoActivity.class);
                        break;
                }
            }
        });
