 ...
 * 我的借条,已完成
 */
public class MyLoanOverActivity extends BaseActivity {
    /**
     * 列表
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_loan_over);
        init();
    }
    ...
    public void init() {
        ...
        adapter.setOnItemClickListener(new OnRecyclerItemCLickListener() {
            ...
            public void onItemClick(View view, int flag) {
                switch (flag) {
                    case 1:
                        Utils.intnet(MyLoanOverActivity.this, LoaningActivity.class);
                        break;
                    case 2:
                        Utils.intnet(MyLoanOverActivity.this, LoanUserInfoActivity.class);
                        break;
                }
            }
        });
