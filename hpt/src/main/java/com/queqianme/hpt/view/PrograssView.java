...
public class PrograssView extends View {
	...
	//梯度渐变的填充颜色
	/** The arc colors. */
	private int[] arcColors = new int[] {Color.rgb(255, 133, 0),Color.rgb(255, 219, 134), Color.rgb(255, 133, 0) };
	
	/** The shadows colors. */
	private int[] shadowsColors = new int[] { 0xFF111111, 0x00AAAAAA, 0x00AAAAAA };
	//灰色轨迹
	/** The path color. */
	private int pathColor = Color.rgb(238, 238, 238);
	 ...
	 */
	public PrograssView(Context context, AttributeSet attrs) {
		super(context, attrs);
		pathWidth = (int) context.getResources().getDimension(R.dimen.x10);
		pathPaint  = new Paint();
		// 设置是否抗锯齿
